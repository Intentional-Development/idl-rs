...
impl NodeKind {
    ...
    pub const ALL: [NodeKind; 18] = [
        NodeKind::Intent, NodeKind::Scope, NodeKind::Entity, NodeKind::Aggregate,
        NodeKind::Variant, NodeKind::Constraints, NodeKind::Event, NodeKind::Operation,
        NodeKind::StateMachine, NodeKind::Rule, NodeKind::Invariant, NodeKind::Policy,
        NodeKind::Api, NodeKind::AccessPattern, NodeKind::Mapping, NodeKind::TraceLink,
        NodeKind::Decision, NodeKind::Verification,
    ];
...
impl FromStr for NodeKind {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        Ok(match s {
            ...
            other => return Err(ParseKindError { input: other.to_string() }),
        })
    }
}
...
impl EdgeKind {
    ...
    pub const ALL: [EdgeKind; 18] = [
        EdgeKind::Realizes, EdgeKind::Verifies, EdgeKind::Triggers, EdgeKind::Emits,
        EdgeKind::Handles, EdgeKind::Constrains, EdgeKind::TracesTo, EdgeKind::ExtractedFrom,
        EdgeKind::Supersedes, EdgeKind::Decides, EdgeKind::Implements, EdgeKind::BelongsTo,
        EdgeKind::VariantOf, EdgeKind::Transitions, EdgeKind::Queries, EdgeKind::Authorizes,
        EdgeKind::Contains, EdgeKind::DerivesFrom,
    ];
